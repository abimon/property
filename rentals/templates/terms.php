...
{%block content%}
{% load static %}
<div style="margin:0px 0px 0px 10vw;">
    <h1 style="color:black; font-weight:bolder;">Terms and Conditions</h1>

    <h3>1. Introduction</h3>

    <p>1.1. Urban Link Properties Limited (hereinafter referred to as "the Company") operates as an intermediary between buyers, tenants, landlords, and sellers of real estate properties.</p>
